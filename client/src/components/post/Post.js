...
import { Container, Jumbotron, Media, ListGroup, ListGroupItem } from 'reactstrap';
...
class Post extends Component{
    ...
    displayReplies = () => {
        const replies = this.state.post.replies
            .map((reply) => (
    ...
    render(){
        ...
        const points = this.state.post.upVotes.length - this.state.post.downVotes.length;
